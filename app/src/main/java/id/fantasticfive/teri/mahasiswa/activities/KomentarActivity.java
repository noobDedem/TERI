...
import id.fantasticfive.teri.mahasiswa.adapters.KomentarAdapter;
import id.fantasticfive.teri.mahasiswa.models.Komentar;
...
public class KomentarActivity extends AppCompatActivity {
    ...
    private TextView namaUser, isiKomentar, waktu;
    private RecyclerView rv;
    private RecyclerView.ItemDecoration mdividerItemDecoration;
    private ArrayList<Komentar> komentarArrayList;
    private String kontenKomentar, nomorInduk, kodeTugas, idKomentar;
    ...
    public class SendKomentar extends AsyncTask<Integer, Void, String>{
        ...
        protected void onPostExecute(String s) {
            if (response_code == HttpURLConnection.HTTP_OK) {
                ...
                Toast.makeText(KomentarActivity.this, "Gagal menghubungkan ke server", Toast.LENGTH_LONG).show();
            }
